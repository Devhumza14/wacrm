...
//
// Registered only when BOTH DZYNECO_ENABLE_WRITES and
// DZYNECO_ENABLE_BROADCASTS are set. A single call can message up to
...
export function registerBroadcastTools(server: McpServer, client: DzynecoClient): void {
  server.registerTool(
    'send_broadcast',
    {
