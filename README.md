...
[![CI](https://github.com/ArnasDon/Dzyneco/actions/workflows/ci.yml/badge.svg)](https://github.com/ArnasDon/Dzyneco/actions/workflows/ci.yml)
[![Next.js 16](https://img.shields.io/badge/Next.js-16-black?logo=nextdotjs)](https://nextjs.org)
[![Supabase](https://img.shields.io/badge/Supabase-Postgres%20%2B%20Auth-3ecf8e?logo=supabase)](https://supabase.com)
[![Stars](https://img.shields.io/github/stars/ArnasDon/Dzyneco?style=social)](https://github.com/ArnasDon/Dzyneco/stargazers)

The marketing site and self-host docs live in a separate repo:
[ArnasDon/Dzyneco-site](https://github.com/ArnasDon/Dzyneco-site)
([Dzyneco.tech](https://Dzyneco.tech)). This repo is the product —
...
```bash
# Fork on GitHub first: https://github.com/ArnasDon/Dzyneco → Fork
git clone https://github.com/<your-username>/Dzyneco.git
cd Dzyneco
npm install
...
<p align="center">
  <a href="https://Dzyneco.tech/docs/deployment-hostinger">
    <img src="https://img.shields.io/badge/Step--by--step_guide-Dzyneco.tech%2Fdocs-111?style=for-the-badge" alt="Step-by-step guide" height="44">
  </a>
</p>

**Dzyneco is built to run on [Hostinger](https://www.hostinger.com/web-apps-hosting?REFERRALCODE=WACRMHOST).**
...
**[Dzyneco.tech/docs/deployment-hostinger](https://Dzyneco.tech/docs/deployment-hostinger)**.

> _Note: Dzyneco is MIT-licensed and runs anywhere Node.js does
...
**[Dzyneco.tech/docs](https://Dzyneco.tech/docs)**
(source: [ArnasDon/Dzyneco-site](https://github.com/ArnasDon/Dzyneco-site)).

Key pages:
- [Getting started](https://Dzyneco.tech/docs/getting-started)
- [Supabase setup](https://Dzyneco.tech/docs/supabase-setup)
- [WhatsApp setup](https://Dzyneco.tech/docs/whatsapp-setup)
- [Environment variables](https://Dzyneco.tech/docs/environment-variables)
- [Deploy on Hostinger](https://Dzyneco.tech/docs/deployment-hostinger)
- [Architecture](https://Dzyneco.tech/docs/architecture)
- [Troubleshooting](https://Dzyneco.tech/docs/troubleshooting)
