...
```bash
# 1. Fork on GitHub: https://github.com/ArnasDon/Dzyneco → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/ArnasDon/Dzyneco.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/ArnasDon/Dzyneco/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `Dzyneco.tech` URL belong to the upstream project; please swap them
