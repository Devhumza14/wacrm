...
export const metadata: Metadata = {
  title: {
    default: "Dzyneco WhatsApp CRM",
    template: "%s — Dzyneco WhatsApp CRM",
  },
  description: "Dzyneco WhatsApp CRM — shared inbox, contacts, pipelines, broadcasts and automations.",
  robots: {
    index: false,
    follow: false,
  },
