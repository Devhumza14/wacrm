...
//
// Why the `dzyneco_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Dzyneco key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `dzyneco_test_` variant if
...
export const API_KEY_PREFIX = 'dzyneco_live_';
