...
- [GitHub Security Advisories](https://github.com/ArnasDon/Dzyneco/security/advisories/new)
...
In scope:
- Anything in this repository (`ArnasDon/Dzyneco`), including webhook and auth
